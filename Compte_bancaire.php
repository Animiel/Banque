...
class Compte_bancaire {
    ...
    public function setSoldeTotal(int $soldeTotal) {
        $this->soldeTotal += $soldeTotal;
    }

    public function setSoldeTotal2(int $montant) {
    ...
    public function __toString() {
        return "Le $this->libelle appartenant à ".$this->personne->getNom()." ".$this->personne->getPrenom()." ayant pour solde initial : $this->soldeInit $this->devise comprend actuellement un solde de $this->soldeTotal $this->devise.<br>";
    }
}
?>